...
To ensure this framework is highly accessible and can be evaluated without requiring a high-end GPU or complex PyTorch environment configurations, this repository is provided as a **Minimal Working Example (MWE)**.
